...
* Tonnage restrictions - all procedural contracts, original and new, may now appear with maximum tonnage restrictions for the player; each system's contracts should be roughly divided 50%-50% between no restrictions and restrictions. Tonnage restrictions are 160t for 0-3 difficulty contracts, 210t for 4-6 and 260t for 7-10.
